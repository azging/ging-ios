...
@protocol DXTextMessageToolBarDelegate;
@interface DXTextMessageToolBar : UIView

@property (nonatomic, weak) id <DXTextMessageToolBarDelegate> delegate;
...
@protocol DXTextMessageToolBarDelegate <NSObject>
