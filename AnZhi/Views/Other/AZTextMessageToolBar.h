...
@protocol AZTextMessageToolBarDelegate;
@interface AZTextMessageToolBar : UIView

@property (nonatomic, weak) id <AZTextMessageToolBarDelegate> delegate;
...
@protocol AZTextMessageToolBarDelegate <NSObject>
