...
@implementation AZTextMessageToolBar
...
+ (AZTextMessageToolBar *)createToolBar:(CGRect)frame placeHolder:(NSString *)placeHolder delegate:(id<AZTextMessageToolBarDelegate>)delegate {
    AZTextMessageToolBar *inputToolBar = [[AZTextMessageToolBar alloc] initWithFrame:frame];
...
- (void)keyboardWilAZhangeFrame:(NSNotification *)notification
{
...
- (void)setupConfigure
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(keyboardWilAZhangeFrame:) name:UIKeyboardWillChangeFrameNotification object:nil];
}
